/*
  ...
  This table stores positions for test_accounts (not real Hyperliquid positions).
  Positions are simulated and tracked using real oracle prices.
*/

-- Test positions table for test accounts
