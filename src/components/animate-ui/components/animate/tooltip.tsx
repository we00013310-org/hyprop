...
function TooltipContent({
  ...
  return (
    <TooltipContentPrimitive
      className={cn("z-50 w-fit bg-textBtn text-black rounded-md", className)}
      {...props}
    >
      ...
      <TooltipArrowPrimitive
        className="fill-textBtn size-3 data-[side='bottom']:translate-y-[1px] data-[side='right']:translate-x-[1px] data-[side='left']:translate-x-[-1px] data-[side='top']:translate-y-[-1px]"
        tipRadius={2}
      />
    </TooltipContentPrimitive>
  );
