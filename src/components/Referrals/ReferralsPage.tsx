    ...
    return (
        <div className="min-h-screen bg-primary-background">
            <div className="max-w-[1920px] mx-auto px-6 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-white mb-2">Referrals</h1>
                ...
                <div className="bg-sectionBg rounded-lg border border-btnBorder overflow-hidden">
                    ...
                    <div className="flex border-b border-btnBorder">
                        <button
                            ...
                            className={`flex-1 px-6 py-4 text-sm font-medium transition-colors ${activeTab === "Referrals"
                        ...
                        <button
                            ...
                            className={`flex-1 px-6 py-4 text-sm font-medium transition-colors ${activeTab === "Legacy Reward History"
                                    ? "text-white border-b-2 border-primary"
                                    : "text-slate-400 hover:text-white"
                                }`}
                        >
                    ...
                    {activeTab === "Legacy Reward History" && (
                        <div className="px-6 py-20 text-center">
                            <p className="text-slate-400">No legacy reward history available</p>
                        </div>
                    )}
                </div>
            </div>
