    ...
    <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 border border-green-500/20 hover:border-green-500/40 transition-colors">
      ...
      <div className="space-y-3 mb-4">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className={`font-semibold ${totalUpnl >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className={`font-semibold ${totalRpnl >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="text-white font-semibold">{account.primary_symbol}</span>
        </div>
      </div>
